        ...
        <form onSubmit={handleRestock} className="space-y-6">
          <div className="space-y-2">
            ...
            <input
              ...
              className="w-full px-4 py-3 bg-slate-950 border border-slate-800 rounded-xl text-xl font-bold text-emerald-400 text-center focus:outline-none focus:border-emerald-500"
            />
          </div>
          ...
          <div className="flex space-x-3">
            ...
            <button
              type="submit"
              disabled={loading}
              className="flex-1 py-3 bg-gradient-to-r from-emerald-500 to-teal-600 text-white hover:brightness-110 rounded-xl text-xs font-extrabold shadow-lg shadow-emerald-500/20 transition-all"
            >
